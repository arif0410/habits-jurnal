...
<body>
    ...
    <div class="habit-card">
        ...
        <h3>Bangun Pagi</h3>
        <p>{{ $wakeUpPercentage }}%</p>
    </div>
    <div class="habit-card">
        <i class="fas fa-pray"></i>
        <h3>Ibadah</h3>
        <p>{{ $worshipPercentage }}%</p>
    </div>
    <div class="habit-card">
        <i class="fas fa-utensils"></i>
        <h3>Sarapan</h3>
        <p>{{ $breakfastPercentage }}%</p>
    </div>
    <div class="habit-card">
    ...
    <div class="habit-card">
        ...
        <footer>
            <div>
                ...
                {{-- <img src="/path/to/your/school-logo.png" alt="Logo Sekolah" class="footer-logo"> --}}
            </div>
