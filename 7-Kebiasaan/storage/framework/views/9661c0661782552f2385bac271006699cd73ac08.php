...
<div class="container">
            ...
            <tbody id="habits-tbody">
                <?php $__empty_1 = true; $__currentLoopData = $habits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $habit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($habit->studentSerial); ?></td>
                        <td><?php echo e($habit->studentClass); ?></td>
                        <td data-sort="<?php echo e(\Carbon\Carbon::parse($habit->date)->format('Ymd')); ?>"><?php echo e(\Carbon\Carbon::parse($habit->date)->format('d/m/Y')); ?></td>
                        <td data-sort="<?php echo e($habit->morningSport[0]); ?>"><span class="badge-habit <?php echo e($habit->morningSport == 'Ya' ? 'badge-yes' : 'badge-no'); ?>"><?php echo e($habit->morningSport[0]); ?></span></td>
                        <td data-sort="<?php echo e(str_replace(':', '', $habit->wakeUpTime)); ?>"><span class="badge-habit badge-time"><?php echo e($habit->wakeUpTime); ?></span></td>
                        <td data-sort="<?php echo e($habit->worship[0]); ?>"><span class="badge-habit <?php echo e($habit->worship == 'Ya' ? 'badge-yes' : 'badge-no'); ?>"><?php echo e($habit->worship[0]); ?></span></td>
                        <td data-sort="<?php echo e($habit->prayer); ?>"><span class="badge-habit <?php echo e($habit->prayer == 'Ya' ? 'badge-yes' : 'badge-no'); ?>"><?php echo e($habit->prayer); ?></span></td>
                        <td data-sort="<?php echo e($habit->breakfast); ?>"><span class="badge-habit <?php echo e($habit->breakfast == 'Ya' ? 'badge-yes' : 'badge-no'); ?>"><?php echo e($habit->breakfast); ?></span></td>
                        <td data-sort="<?php echo e($habit->learningActivity); ?>"><span class="badge-habit <?php echo e($habit->learningActivity == 'Ya' ? 'badge-yes' : 'badge-no'); ?>"><?php echo e($habit->learningActivity); ?></span></td>
                        <td data-sort="<?php echo e($habit->communityActivity); ?>"><span class="badge-habit <?php echo e($habit->communityActivity == 'Ya' ? 'badge-yes' : 'badge-no'); ?>"><?php echo e($habit->communityActivity); ?></span></td>
                        <td data-sort="<?php echo e(str_replace(':', '', $habit->bedtime)); ?>"><span class="badge-habit badge-time"><?php echo e($habit->bedtime); ?></span></td>
                        <td>
                            <form action="<?php echo e(route('habits.destroy', $habit->id)); ?>" method="POST" onsubmit="return confirm('Yakin hapus data ini?')" style="display:inline;">
                                <?php echo csrf_field(); ?>
    ...
    <!-- Pagination Laravel -->
    <?php if(method_exists($habits, 'links')): ?>
        <div class="mt-3">
            <?php echo e($habits->appends(request()->query())->links('pagination::bootstrap-4')); ?>
...
<div class="flex justify-between items-center mb-4">
    <div>
        ...
        <select name="per_page" id="per_page" onchange="changePerPage(this.value)" class="border rounded p-1">
            ...
            <option value="32" <?php echo e($perPage == 32 ? 'selected' : ''); ?>>32</option>
